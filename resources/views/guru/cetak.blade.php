        ...
        <div class="container-fluid">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-6">
                        <a href="{{ url('guru/cetak/cetak-semua') }}" class="btn btn-success float-right ion-printer"
                            target="_blank"> Cetak Semua</a>
                        <a href="{{ url('guru/cetak/pertanggal') }}" class="btn btn-warning float-right ion-ios-calendar"
                            style="margin-right: 10px"> Cetak Pertanggal</a>
                    </div>
                </div>
            </div>
