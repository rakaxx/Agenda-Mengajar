            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-10">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <input type="text" name="mapel" class="form-control"
                                                    value="{{ $model->mapel }}" readonly>
                                            </div>
                                            <div class="col-6">
                                                <label>Kelas</label>
                                                <input type="text" name="kelas" class="form-control"
                                                    value="{{ $model->kelas }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="materi"
                                            placeholder="Masukkan Materi" value="{{ $model->materi }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label>Jumlah Siswa</label>
                                        <input type="text" class="form-control" name="jumlah_siswa"
                                            placeholder="Masukkan Jumlah Siswa" value="{{ $model->jumlah_siswa }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-3">
                                                ...
                                                <input type="text" class="form-control" name="hadir"
                                                    placeholder="Jumlah Siswa Hadir" value="{{ $model->hadir }}" readonly>
                                            </div>
                                            <div class="col-3">
                                                <label>Siswa Sakit</label>
                                                <input type="text" class="form-control" name="sakit"
                                                    placeholder="Jumlah Siswa Sakit" value="{{ $model->sakit }}" readonly>
                                            </div>
                                            <div class="col-3">
                                                <label>Siswa Izin</label>
                                                <input type="text" class="form-control" name="izin"
                                                    placeholder="Jumlah Izin" value="{{ $model->izin }}" readonly>
                                            </div>
                                            <div class="col-3">
                                                <label>Siswa Tanpa Keterangan</label>
                                                <input type="text" class="form-control" name="tanpa_ket"
                                                    placeholder="Jumlah Siswa Tanpa Ket" value="{{ $model->tanpa_ket }}"
                                                    readonly>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <!-- /.row -->
                        <div class="form-group">
                            <a href="{{ url('admin/draf') }}" class="btn btn-warning ion-ios-arrow-back"> Kembali</a>
                        </div>
                    </div>
                    <!-- /.container-fluid -->
        </section>
