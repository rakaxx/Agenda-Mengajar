            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form method="POST" action="{{ url('mapel/' . $value->id) }}" style="margin: 0; padding: 0;">
                                                    @csrf
                                                    <a href="{{ url('mapel/' . $value->id . '/edit') }}"
                            ...
                            <div style="margin-top: 10px">
                                {{ $tmapel->links('vendor.pagination.bootstrap-4') }}
                            </div>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    ...
                    <div class="form-group">
                        <a href="{{ url('admin/mapel/tambah') }}" class="btn btn-primary ion-ios-plus-outline"> Tambah
                            Mapel</a>
                    </div>
