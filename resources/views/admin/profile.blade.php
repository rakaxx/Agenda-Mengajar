...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    <label>NIDN</label>
                                    <input type="text" class="form-control" name="nidn" value="{{ $value->nidn }}"
                                        readonly>
                                </div>
                                <div class="form-group">
                                    <label>Nama</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password"
                                        value="{{ $value->password }}" placeholder="Masukkan Password">
                                </div>
                            </div><!-- /.card-body -->
                        </div>
                        <!-- /.card -->
            ...
            @endforeach
            <div class="form-group">
                <a href="{{ url('admin/dashboard') }}" class="btn btn-warning ion-ios-arrow-back float-right"> Kembali</a>
                <button type="submit" class="btn btn-primary ion-android-done float-right" style="margin-right: 10px">
                    Simpan</button>
                <!-- /.row -->
            </div><!-- /.container-fluid -->
    </section>
